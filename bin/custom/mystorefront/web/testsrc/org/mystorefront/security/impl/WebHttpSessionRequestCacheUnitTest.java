...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mystorefront/electronics/en",
						"https://electronics.local:9002/mystorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mystorefront/electronics/en",
						"https://electronics.local:9002/mystorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mystorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/mystorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mystorefront/electronics/en",
						"https://electronics.local:9002/mystorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mystorefront",
						"https://electronics.local:9002/mystorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mystorefront",
						"https://electronics.local:9002/mystorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/mystorefront/electronics/en",
						"https://electronics.local:9002/mystorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
